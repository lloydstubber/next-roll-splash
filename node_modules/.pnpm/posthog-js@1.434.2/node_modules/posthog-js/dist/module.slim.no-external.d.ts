import { ActionStepStringMatching, ActionStepType, ApiResponse, BasicSurveyQuestion, CaptureOptions as CaptureOptions$1, CapturedEventInfo, Client, Compression, ConversationsRemoteConfig, DeepReadonly, DisplaySurveyType, Disposable, ErrorTrackingSuppressionRule, ErrorTrackingSuppressionRuleValue, Extension, ExtensionToken, FlagVariant, KeyValueStore, LinkSurveyQuestion, Listener, MultipleSurveyQuestion, NetworkRecordOptions, PropertyFilters, PropertyMatchType, PropertyOperator, RatingSurveyQuestion, RemoteConfig, RemoteConfig as RemoteConfig$1, RemoteConfigResult as RemoteConfigResult$1, SendRequestInit, SessionContext as SessionContext$1, SessionRecordingEventTrigger, SessionRecordingRemoteConfig, SessionRecordingRemoteConfig as SessionRecordingRemoteConfig$1, SessionRecordingTriggerGroup, SessionRecordingTriggerPropertyFilter, SessionRecordingUrlTrigger, Survey, Survey as Survey$1, SurveyActionType, SurveyAppearance, SurveyEventName, SurveyEventProperties, SurveyEventType, SurveyEventWithFilters, SurveyPosition, SurveyQuestion, SurveyQuestionBranchingType, SurveyQuestionDescriptionContentType, SurveyQuestionType, SurveySchedule, SurveyTabPosition, SurveyType, SurveyWidgetType, SurveyWithTypeAndAppearance, WidgetPosition } from "@posthog/browser-common";
import { ErrorTracking, KnownUnsafeEditableEvent, LogSdkContext, Logger as Logger$1, SurveyPosition as SurveyPosition$1, SurveyResponseValue as SurveyResponseValue$1 } from "@posthog/core";
import { AutocaptureCompatibleElement, AutocaptureConfig, BeforeSendFn, BeforeSendMetricFn, BootstrapConfig, BrowserMetricsConfig, CanvasMaskRegion, CaptureLogOptions, CaptureMetricOptions, CaptureOptions, CapturePageviewOptions, CaptureResult, CapturedNetworkRequest, ConfigDefaults, DeadClickCandidate, DeadClicksAutoCaptureConfig, DomAutocaptureEvents, EarlyAccessFeature, EarlyAccessFeatureCallback, EarlyAccessFeatureResponse, EarlyAccessFeatureStage, ErrorTrackingOptions, EvaluationReason, EventName, EventName as EventName$1, ExceptionAutoCaptureConfig, ExceptionStepsConfig, ExternalIntegrationKind, FeatureFlagDetail, FeatureFlagDetail as FeatureFlagDetail$1, FeatureFlagMetadata, FeatureFlagOptions, FeatureFlagOverrideOptions, FeatureFlagOverrides, FeatureFlagPayloadOverrides, FeatureFlagResult, FeatureFlagsCallback, Headers, HeatmapConfig, InitiatorType, IsFeatureEnabledOptions, JsonRecord, JsonType, JsonType as JsonType$1, KnownEventName, LogAttributeValue, LogAttributes, LogSeverityLevel, Logger, MaskInputOptions, MetricAttributeValue, MetricAttributes, MetricSample, MetricType, MetricsConfig, NetworkMetricsConfig, NetworkMetricsRequest, NetworkMetricsResponse, NetworkRequest, OtlpAnyValue, OtlpKeyValue, OtlpLogRecord, OtlpLogsPayload, OtlpMetricsPayload, OtlpSeverityEntry, OtlpSeverityText, OverrideFeatureFlagsOptions, PerformanceCaptureConfig, PostHog as PostHog$1, PostHogConfig as PostHogConfig$1, Properties, Properties as Properties$1, Property, RageclickConfig, RemoteConfigFeatureFlagCallback, RequestCallback, RequestQueueConfig, RequestResponse, RequestResponse as RequestResponse$1, ResetOptions, SegmentEnrichmentFilterFn, SegmentIntegrationConfig, SessionIdChangedCallback, SessionRecordingCanvasOptions, SessionRecordingOptions, SessionRecordingSamplingConfig, SeverityLevel, SlimDOMOptions, SupportedWebVitalsMetrics, SurveyRenderReason, ToolbarParams, ToolbarSource, ToolbarUserIntent, ToolbarVersion, TreeShakeable } from "@posthog/types";
import { createLogger } from "@posthog/browser-common/utils/logger";
import { SimpleEventEmitter } from "@posthog/browser-common/utils/simple-event-emitter";
//#endregion
//#region lib/src/consent.d.ts
...
//#endregion
//#region lib/src/extensions/replay/external/triggerMatching.d.ts
...
//#endregion
//#region lib/src/extensions/types.d.ts
type ExtensionConstructor<T extends Extension$1> = new (instance: PostHog, ...args: any[]) => T;
...
//#endregion
//#region lib/src/extensions/rageclick.d.ts
...
//#endregion
//#region lib/src/autocapture-config.d.ts
interface AutocaptureConfig$1 extends AutocaptureConfig {
  enabled: boolean;
...
interface AutocaptureConfigSource {
  refresh(config: AutocaptureConfig$1): void;
}
//#endregion
//#region lib/src/autocapture.d.ts
declare class Autocapture implements Extension {
  private readonly _configSource;
  readonly name: import("@posthog/browser-common").ExtensionToken<Autocapture>;
  ...
  private _pointerExpiry?;
  private _clearPointer;
  private _isExcludedPointerTarget;
  private _trackPointer;
  private _recoverClickTarget;
  ...
  getElementSelectors(element: Element | null, additionalElement?: Element): string[] | null;
  get isEnabled(): boolean;
  private _captureEvent;
  isBrowserSupported(): boolean;
}
//#endregion
//#region lib/src/sessionid.d.ts
...
//#endregion
//#region lib/src/posthog-conversations-types.d.ts
/**
...
//#endregion
//#region lib/src/utils/globals.d.ts
interface LazyLoadedDeadClicksAutocaptureInterface {
  start: (observerTarget: Node) => void;
  stop: () => void;
}
//#endregion
//#region lib/src/extensions/dead-clicks-autocapture.d.ts
declare class DeadClicksAutocapture implements Extension$1 {
...
//#endregion
//#region lib/src/extensions/exception-autocapture/index.d.ts
...
//#endregion
//#region lib/src/extensions/tracing-headers.d.ts
declare class TracingHeaders implements Extension$1 {
...
//#endregion
//#region lib/src/extensions/web-vitals/index.d.ts
...
//#endregion
//#region lib/src/extensions/replay/session-recording.d.ts
declare class SessionRecording implements Extension$1 {
  private readonly _instance;
...
//#endregion
//#region lib/src/heatmaps.d.ts
type HeatmapEventBuffer = {
  [key: string]: Properties[];
} | undefined;
declare class Heatmaps implements Extension$1 {
  instance: PostHog;
  rageclicks: RageClick;
...
type SurveyCallback = (surveys: Survey$1[], context?: {
  isLoaded: boolean;
  error?: string;
}) => void;
...
//#endregion
//#region lib/src/extensions/product-tours/element-inference.d.ts
...
//#endregion
//#region lib/src/posthog-product-tours-types.d.ts
...
//#endregion
//#region lib/src/posthog-product-tours.d.ts
declare class PostHogProductTours implements Extension$1 {
  private _instance;
...
//#endregion
//#region lib/src/site-apps.d.ts
declare class SiteApps implements Extension$1 {
  private _instance;
...
//#endregion
//#region lib/src/extensions/surveys/action-matcher.d.ts
...
//#endregion
//#region lib/src/utils/event-receiver.d.ts
/**
...
//#endregion
//#region lib/src/utils/survey-event-receiver.d.ts
...
//#endregion
//#region lib/src/surveys-config.d.ts
...
//#endregion
//#region lib/src/posthog-surveys.d.ts
...
declare class PostHogSurveys implements Extension {
  ...
  readonly name: import("@posthog/browser-common").ExtensionToken<PostHogSurveys>;
...
//#endregion
//#region lib/src/browser-surveys.d.ts
...
//#endregion
//#region lib/src/extensions/toolbar.d.ts
declare class Toolbar implements Extension$1 {
  instance: PostHog;
  constructor(instance: PostHog);
...
//#endregion
//#region lib/src/posthog-exceptions.d.ts
declare class PostHogExceptions implements Extension$1 {
  private readonly _instance;
...
//#endregion
//#region lib/src/web-experiments-types.d.ts
...
//#endregion
//#region lib/src/web-experiments.d.ts
declare class WebExperiments implements Extension$1 {
  private _instance;
...
//#endregion
//#region lib/src/extensions/conversations/posthog-conversations.d.ts
declare class PostHogConversations implements Extension$1 {
  private _instance;
...
//#endregion
//#region lib/src/feature-flags-config.d.ts
...
//#endregion
//#region lib/src/posthog-featureflags.d.ts
declare class PostHogFeatureFlags implements Extension {
  ...
  private _dueRefreshIntervalMs?;
  private _hadUserInteraction;
  ...
  private _onVisibilityChange;
  private _resumeConfiguredInterval;
...
//#endregion
//#region lib/src/posthog-logs.d.ts
declare class PostHogLogs implements Extension {
  private readonly _instance;
  readonly name: import("@posthog/browser-common").ExtensionToken<PostHogLogs>;
...
//#endregion
//#region lib/src/posthog-metrics.d.ts
/**
 ...
 */
declare class PostHogMetrics implements Extension$1 {
  private readonly _instance;
  private readonly _logger;
  private _core;
  private _resolvedFrom;
  private _stopNetworkMetrics;
  private _disposed;
  constructor(_instance: PostHog);
  initialize(): void;
  onConfigChange(): void;
...
interface RequestWithOptions {
  ...
  callback?: (response: RequestResponse$1) => void;
  timeout?: number;
  noRetries?: boolean;
...
type SessionRecordingPersistedConfig = Omit<SessionRecordingRemoteConfig$1, 'recordCanvas' | 'canvasFps' | 'canvasQuality' | 'networkPayloadCapture' | 'sampleRate' | 'minimumDurationMilliseconds'> & {
  /**
  ...
  enabled: boolean;
  networkPayloadCapture: SessionRecordingRemoteConfig$1['networkPayloadCapture'] & {
    capturePerformance: RemoteConfig$1['capturePerformance'];
  };
  canvasRecording: {
    enabled: SessionRecordingRemoteConfig$1['recordCanvas'];
    fps: SessionRecordingRemoteConfig$1['canvasFps'];
    quality: SessionRecordingRemoteConfig$1['canvasQuality'];
  };
 ...
 */
interface FlagsResponse extends RemoteConfig$1 {
  featureFlags: Record<string, string | boolean>;
  featureFlagPayloads: Record<string, JsonType$1>;
  errorsWhileComputingFlags: boolean;
  requestId?: string;
  flags: Record<string, FeatureFlagDetail$1>;
  evaluatedAt?: number;
  /**
...
type ErrorEventArgs = [event: string | Event, source?: string | undefined, lineno?: number | undefined, colno?: number | undefined, error?: Error | undefined];
...
//#endregion
//#region lib/src/extensions/sentry-integration.d.ts
...
//#endregion
//#region lib/src/posthog-persistence.d.ts
/**
...
declare class PostHogPersistence {
  ...
  private _metaIdentifierChangePending;
...
//#endregion
//#region lib/src/rate-limiter.d.ts
...
//#endregion
//#region lib/src/remote-config.d.ts
...
//#endregion
//#region lib/src/request-queue.d.ts
declare class RequestQueue {
  ...
  constructor(sendRequest: (req: QueuedRequestWithOptions, transportOverride?: QueuedRequestWithOptions['transport']) => void, config?: RequestQueueConfig);
...
//#endregion
//#region lib/src/retry-queue.d.ts
declare class RetryQueue {
  ...
  resume(): void;
  get length(): number;
  retriableRequest({ retriesPerformedSoFar, ...options }: RetriableRequestWithOptions, transportOverride?: RetriableRequestWithOptions['transport']): void;
  private _enqueue;
  private _poll;
  private _flush;
  unload(): void;
...
//#endregion
//#region lib/src/scroll-manager.d.ts
...
//#endregion
//#region lib/src/session-props.d.ts
...
//#endregion
//#region lib/src/utils/request-router.d.ts
/**
...
//#endregion
//#region lib/src/extensions/external-integration.d.ts
...
//#endregion
//#region lib/src/extensions/browser-client.d.ts
...
declare class BrowserClientAdapter implements Client, Disposable {
  ...
  capture(event: string, properties?: Properties | null, options?: CaptureOptions$1): void;
...
//#endregion
//#region lib/src/browser-autocapture.d.ts
...
//#endregion
//#region lib/src/posthog-core.d.ts
...
declare class PostHog implements PostHogInterface {
  ...
  _send_retriable_request(options: QueuedRequestWithOptions, transportOverride?: QueuedRequestWithOptions['transport']): void;
  /**
  ...
  private get _facebookClickIdChannel();
  private get _facebookBrowserIdChannel();
  private _getPersistedMetaIdentifier;
  private _storeMetaIdentifier;
  private _readMetaCookie;
  private _updateFacebookClickId;
  private _updateFacebookBrowserId;
  private _markMetaIdentifierDelivered;
  /**
...
declare namespace extension_bundles_d_exports {
...
//#endregion
//#region lib/src/entrypoints/module.slim.no-external.es.d.ts
declare module '@posthog/types' {
  interface TreeShakeableConfig {
    optional: true;
  }
}
declare const posthog$1: PostHog;
//#endregion
export { type ActionStepStringMatching, type ActionStepType, type AutocaptureCompatibleElement, type AutocaptureConfig, type BasicSurveyQuestion, type BeforeSendFn, type BeforeSendMetricFn, type BootstrapConfig, type BrowserMetricsConfig, type extension_bundles_d_exports as BundleTypes, type CanvasMaskRegion, type CaptureLogOptions, type CaptureMetricOptions, type CaptureOptions, type CapturePageviewOptions, type CaptureResult, type CapturedNetworkRequest, Compression, type ConfigDefaults, type ConversationsRemoteConfig, ConversationsTraits, ConversationsUnavailableReason, ConversationsWidgetState, DEFAULT_PRODUCT_TOUR_APPEARANCE, type DeadClickCandidate, type DeadClicksAutoCaptureConfig, DisplaySurveyOptions, DisplaySurveyPopoverOptions, DisplaySurveyType, type DomAutocaptureEvents, type EarlyAccessFeature, type EarlyAccessFeatureCallback, type EarlyAccessFeatureResponse, type EarlyAccessFeatureStage, ErrorEventArgs, type ErrorTrackingOptions, type ErrorTrackingSuppressionRule, type ErrorTrackingSuppressionRuleValue, type EvaluationReason, EventHandler, type EventName, type ExceptionAutoCaptureConfig, type ExceptionStepsConfig, type ExternalIntegrationKind, type FeatureFlagDetail, type FeatureFlagMetadata, type FeatureFlagOptions, type FeatureFlagOverrideOptions, type FeatureFlagOverrides, type FeatureFlagPayloadOverrides, type FeatureFlagResult, type FeatureFlagsCallback, type FlagVariant, FlagsResponse, GetMessagesResponse, GetTicketsOptions, GetTicketsResponse, type Headers, type HeatmapConfig, type InitiatorType, type IsFeatureEnabledOptions, JSONContent, type JsonRecord, type JsonType, type KnownEventName, type KnownUnsafeEditableEvent, type LinkSurveyQuestion, type LogAttributeValue, type LogAttributes, type LogSdkContext, type LogSeverityLevel, type Logger, MarkAsReadResponse, type MaskInputOptions, Message, MessageAuthorType, type MetricAttributeValue, type MetricAttributes, type MetricSample, type MetricType, type MetricsConfig, type MultipleSurveyQuestion, type NetworkMetricsConfig, type NetworkMetricsRequest, type NetworkMetricsResponse, type NetworkRecordOptions, type NetworkRequest, type OtlpAnyValue, type OtlpKeyValue, type OtlpLogRecord, type OtlpLogsPayload, type OtlpMetricsPayload, type OtlpSeverityEntry, type OtlpSeverityText, OverrideConfig, type OverrideFeatureFlagsOptions, type PerformanceCaptureConfig, PersistentStore, PostHog, PostHogConfig, PostHogInterface, ProductTour, ProductTourAppearance, ProductTourBannerConfig, ProductTourButtonAction, ProductTourCallback, ProductTourConditions, ProductTourDismissReason, ProductTourDisplayFrequency, ProductTourEventName, ProductTourEventProperties, ProductTourRenderReason, ProductTourSelectorError, ProductTourStep, ProductTourStepButton, ProductTourStepButtons, ProductTourStepTranslation, ProductTourStepType, ProductTourSurveyQuestion, ProductTourSurveyQuestionType, ProductTourType, ProductTourWaitPeriod, type Properties, type Property, type PropertyFilters, type PropertyMatchType, type PropertyOperator, QueuedRequestWithOptions, type RageclickConfig, type RatingSurveyQuestion, type RemoteConfig, type RemoteConfigFeatureFlagCallback, RemoteConfigResult, type RequestCallback, type RequestQueueConfig, type RequestResponse, RequestRestoreLinkPayload, RequestRestoreLinkResponse, RequestWithOptions, type ResetOptions, RestoreFromTokenPayload, RestoreFromTokenResponse, RestoreFromTokenStatus, RetriableRequestWithOptions, type SegmentEnrichmentFilterFn, type SegmentIntegrationConfig, SendMessagePayload, SendMessageResponse, SessionContext, type SessionIdChangedCallback, type SessionRecordingCanvasOptions, type SessionRecordingEventTrigger, type SessionRecordingOptions, SessionRecordingPersistedConfig, type SessionRecordingRemoteConfig, type SessionRecordingSamplingConfig, type SessionRecordingTriggerGroup, type SessionRecordingTriggerPropertyFilter, type SessionRecordingUrlTrigger, SessionStartReason, type SeverityLevel, ShowTourOptions, SiteApp, SiteAppGlobals, SiteAppLoader, type SlimDOMOptions, SnippetArrayItem, type SupportedWebVitalsMetrics, type Survey, type SurveyActionType, type SurveyAppearance, SurveyCallback, SurveyConfig, SurveyElement, SurveyEventName, SurveyEventProperties, SurveyEventType, type SurveyEventWithFilters, SurveyPosition, type SurveyQuestion, SurveyQuestionBranchingType, type SurveyQuestionDescriptionContentType, SurveyQuestionType, type SurveyRenderReason, SurveyResponseValue, SurveySchedule, SurveyTabPosition, SurveyType, SurveyWidgetType, type SurveyWithTypeAndAppearance, Ticket, TicketStatus, TipTapDoc, TipTapMark, TipTapNode, type ToolbarParams, type ToolbarSource, type ToolbarUserIntent, type ToolbarVersion, UserProvidedTraits, type WidgetPosition, posthog$1 as default, posthog$1 as posthog, severityLevels };