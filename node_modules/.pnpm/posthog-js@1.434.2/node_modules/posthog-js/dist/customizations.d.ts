...
import { ApiResponse, Client, Compression, DeepReadonly, DisplaySurveyType, Extension, PropertyMatchType, RemoteConfig, RemoteConfigResult, SendRequestInit, Survey, Survey as Survey$1, SurveyActionType, SurveyEventWithFilters, SurveyPosition as SurveyPosition$1, SurveyWithTypeAndAppearance } from "@posthog/browser-common";
import { ErrorTracking, LogSdkContext, SurveyPosition, SurveyResponseValue } from "@posthog/core";
import { AutocaptureConfig, BeforeSendFn, CaptureLogOptions, CaptureMetricOptions, CaptureResult, DeadClicksAutoCaptureConfig, EarlyAccessFeatureCallback, EarlyAccessFeatureStage, EventName, FeatureFlagDetail, FeatureFlagDetail as FeatureFlagDetail$1, FeatureFlagOptions, FeatureFlagResult, FeatureFlagsCallback, IsFeatureEnabledOptions, JsonType, JsonType as JsonType$1, KnownEventName, Logger, OverrideFeatureFlagsOptions, PostHog as PostHog$1, PostHogConfig, Properties, Properties as Properties$1, RageclickConfig, RemoteConfigFeatureFlagCallback, SupportedWebVitalsMetrics, SurveyRenderReason, ToolbarParams } from "@posthog/types";
...
interface Extension$1 {
   ...
   */
  onRemoteConfig?(result: RemoteConfigResult$1): void;
}
//#endregion
...
declare class SurveyManager {
  ...
  renderSurvey: (survey: Survey$1, selector: Element, properties?: Properties$1) => void;
...
declare class SurveyEventReceiver extends EventReceiver<Survey$1> {
  constructor(instance: PostHog);
  ...
  protected _getItems(callback: (items: Survey$1[]) => void): void;
...
declare class PostHogSurveys implements Extension {
  ...
  private get _config();
  initialize(): void;
  onRemoteConfig: (result: DeepReadonly<RemoteConfigResult$1>) => void;
  reset(): void;
  loadIfEnabled(): void;
  ...
  canRenderSurvey(surveyId: string | Survey$1): SurveyRenderReason;
  canRenderSurveyAsync(surveyId: string, forceReload: boolean): Promise<SurveyRenderReason>;
  renderSurvey(surveyId: string | Survey$1, selector: string, properties?: Properties$1): void;
...
declare class PostHogExceptions implements Extension$1 {
  ...
  addExceptionStep(message: string, properties?: Properties$1): void;
  sendExceptionEvent(properties: Properties$1): CaptureResult | undefined;
...
interface FeatureFlagsConfig {
  readonly bootstrap: {
    ...
    readonly featureFlagPayloads?: Readonly<Record<string, JsonType$1>>;
  };
...
declare class PostHogFeatureFlags implements Extension {
  ...
  updateConfig(config: PostHogConfig$1, remoteRequestsDisabled: boolean): void;
  setup(client: Client): void | Promise<void>;
  ...
  initialize(): void;
  updateFlags(flags: Record<string, boolean | string>, payloads?: Record<string, JsonType$1>, options?: {
    merge?: boolean;
  }): void;
  get hasLoadedFlags(): boolean;
  getFlags(): string[];
  getFlagsWithDetails(): Record<string, FeatureFlagDetail$1>;
  getAllFeatureFlags(): FeatureFlagResult[];
  getFlagVariants(): Record<string, string | boolean>;
  getFlagPayloads(): Record<string, JsonType$1>;
  /**
  ...
  getFeatureFlagDetails(key: string): FeatureFlagDetail$1 | undefined;
  /**
   ...
   */
  getFeatureFlagPayload(key: string): JsonType$1;
  /**
   ...
   */
  setPersonPropertiesForFlags(properties: Properties$1, reloadFeatureFlags?: boolean): void;
...
type PostHogInterface = Omit<PostHog$1, 'config' | 'init' | 'set_config'> & {
  config: PostHogConfig$1;
  set_config(config: Partial<PostHogConfig$1>): void;
};
type PostHogConfig$1 = Omit<PostHogConfig, 'loaded'> & {
 ...
 * @internal
 */
type RemoteConfigResult$1 = RemoteConfigResult;
/**
...
//#endregion
//#region lib/src/customizations/setAllPersonProfilePropertiesAsPersonPropertiesForFlags.d.ts
type PostHogWithFlags = Pick<PostHogInterface, 'setPersonPropertiesForFlags'> & {
  config: Pick<PostHogConfig$1, 'mask_personal_data_properties' | 'custom_personal_data_properties' | 'detect_google_search_app' | 'disable_capture_url_hashes' | 'custom_campaign_params'>;
};
declare const setAllPersonProfilePropertiesAsPersonPropertiesForFlags: (posthog: PostHogWithFlags) => void;
//#endregion
//#region lib/src/customizations/before-send.d.ts
/**
...
//#endregion
//#region lib/src/customizations/posthogReduxLogger.d.ts
/**
 * An *unknown* action.
