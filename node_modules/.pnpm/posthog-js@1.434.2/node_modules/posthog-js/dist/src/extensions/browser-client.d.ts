import type { ApiResponse, CaptureOptions as BrowserCommonCaptureOptions, CapturedEventInfo, Client, DeepReadonly, Disposable, Extension, ExtensionToken, KeyValueStore, Listener, SendRequestInit, SessionContext } from '@posthog/browser-common';
