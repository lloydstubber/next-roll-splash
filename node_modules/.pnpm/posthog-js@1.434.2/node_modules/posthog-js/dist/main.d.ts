...
type ExtensionConstructor<T extends Extension$1> = new (instance: PostHog$1, ...args: any[]) => T;
...
declare class DeadClicksAutocapture implements Extension$1 {
  ...
  constructor(instance: PostHog$1, isEnabled: (dca: DeadClicksAutocapture) => boolean, onCapture?: DeadClicksAutoCaptureConfig['__onCapture']);
  onRemoteConfig(result: RemoteConfigResult): void;
...
declare class ExceptionObserver {
  ...
  constructor(instance: PostHog$1);
...
declare class TracingHeaders implements Extension$1 {
  ...
  constructor(_instance: PostHog$1);
  initialize(): void;
  private _loadScript;
...
declare class ActionMatcher {
  ...
  constructor(_instance?: PostHog$1 | undefined);
  init(): void;
  dispose(): void;
...
declare abstract class EventReceiver<T extends EventTriggerable> {
  ...
  protected readonly _instance?: PostHog$1;
  /**
...
type PostHogInterface = Omit<PostHog$2, 'config' | 'init' | 'set_config'> & {
...
//#endregion
//#region lib/src/entrypoints/main.cjs.d.ts
declare const posthog$1: import('./module').PostHog;
//#endregion
