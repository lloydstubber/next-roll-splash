...
var network_metrics_1 = require("./extensions/network-metrics");
...
var PostHogMetrics = /** @class */ (function () {
    ...
    PostHogMetrics.prototype.onConfigChange = function () {
        var _a;
        if (this._disposed) {
            return;
        }
        var enabled = !!((_a = this._instance.config.metrics) === null || _a === void 0 ? void 0 : _a.network);
        if (enabled && !this._stopNetworkMetrics) {
            this._stopNetworkMetrics = (0, network_metrics_1.startNetworkMetrics)(this._instance);
        }
     ...
     */
    PostHogMetrics.prototype.dispose = function () {
        var _a, _b;
        this._disposed = true;
        (_a = this._stopNetworkMetrics) === null || _a === void 0 ? void 0 : _a.call(this);
        this._stopNetworkMetrics = undefined;
