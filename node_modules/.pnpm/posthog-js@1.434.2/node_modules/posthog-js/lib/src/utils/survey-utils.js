...
exports.SURVEY_CAPTURING_DISABLED = 'PostHog is not capturing, so a survey response cannot be recorded';
/**
 ...
 */
function isCapturingEnabled(posthog) {
    return (0, core_1.isFunction)(posthog.is_capturing) ? posthog.is_capturing() : !posthog.has_opted_out_capturing();
}
