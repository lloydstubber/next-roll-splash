...
var stack_overflow_1 = require("./utils/stack-overflow");
...
var MASKED_EXTENSION_EXCEPTION_VALUE = [
...
var PostHogExceptions = /** @class */ (function () {
    ...
    PostHogExceptions.prototype.sendExceptionEvent = function (properties) {
        try {
            ...
            try {
                ...
                if (!(0, stack_overflow_1.isStackOverflowError)(error)) {
    ...
    PostHogExceptions.prototype._isExtensionException = function (exceptionList) {
        ...
        var extensionFrames = frames.filter(function (_a) {
        ...
        var onlyMaskedExtensionFrames = extensionFrames.every(function (_a) {
            var filename = _a.filename;
            return !!filename && filename.startsWith(MASKED_URL_PREFIX);
        });
        if (onlyMaskedExtensionFrames) {
            var hasKnownExtensionSignature = exceptionList.some(function (_a) {
                var type = _a.type, value = _a.value;
                return type === 'NoResponse' ||
                    ((0, core_1.isString)(value) &&
                        MASKED_EXTENSION_EXCEPTION_VALUE.some(function (_a) {
                            var signature = _a.value, exact = _a.exact;
                            return exact ? value === signature : value.includes(signature);
                        }));
            });
            return (hasKnownExtensionSignature &&
                !frames.some(function (_a) {
                    var in_app = _a.in_app, filename = _a.filename;
                    return in_app && !(filename === null || filename === void 0 ? void 0 : filename.startsWith(MASKED_URL_PREFIX));
                }));
        }
        return true;
    };
