...
var SurveyManager = /** @class */ (function () {
    function SurveyManager(posthog) {
        ...
        this.handlePageUnload = function () {
            ...
            try {
                for (var surveys_2 = __values(surveys), surveys_2_1 = surveys_2.next(); !surveys_2_1.done; surveys_2_1 = surveys_2.next()) {
                    var survey = surveys_2_1.value;
                ...
                try {
                    if (surveys_2_1 && !surveys_2_1.done && (_a = surveys_2.return)) _a.call(surveys_2);
                }
     ...
     */
    SurveyManager.prototype.clearInMemoryInProgressSurveyState = function () {
        (0, surveys_extension_utils_1.clearAllInMemoryInProgressSurveyState)();
    };
...
function Questions(_a) {
    ...
    var onNextButtonClick = function (_a) {
        ...
        var _b = (0, surveys_1.recordSurveyAnswer)({ responses: questionsResponses, questionSnapshots: questionSnapshots }, questionId, res, surveyQuestions[displayQuestionIndex]), newResponses = _b.responses, newSnapshots = _b.questionSnapshots;
