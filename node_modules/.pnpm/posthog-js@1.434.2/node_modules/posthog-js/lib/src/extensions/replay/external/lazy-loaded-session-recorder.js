        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 7:
                    ...
                    logger.warn('could not compress event asynchronously - trying synchronous compression', e_1);
...
var LazyLoadedSessionRecording = /** @class */ (function () {
    function LazyLoadedSessionRecording(_instance, documentWasEverVisible) {
        ...
        this._pendingBufferStorageKey =
            'ph' + exports.PENDING_BUFFER_STORAGE_SUFFIX + '_' + JSON.stringify([persistenceName, this._instance.config.token]);
    ...
    LazyLoadedSessionRecording.prototype._captureProcessedEvent = function (event, eventToSend, size, targetSessionId, targetWindowId) {
        ...
        if (size === sessionrecording_utils_1.UNSTRINGIFIABLE_EVENT_SIZE) {
    ...
    LazyLoadedSessionRecording.prototype._processQueuedCompressionEventSync = function (queuedEvent) {
        ...
        try {
            ...
            if ((0, core_1.isUndefined)(size)) {
                size = (0, sessionrecording_utils_1.estimateSize)(queuedEvent.event);
            }
            try {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 7:
                        ...
                        logger.warn('could not process queued compression event - will use uncompressed event', e_2);
                        eventToSend = event;
        ...
        if (validatedBuffer.data.length > 0) {
            ...
            snapshotEvents.forEach(function (snapshotBuffer) {
                ...
                try {
                    ...
                    _this._captureSnapshot(__assign({ $snapshot_bytes: snapshotBuffer.size, $snapshot_data: snapshotBuffer.data, $session_id: snapshotBuffer.sessionId, $window_id: snapshotBuffer.windowId, $lib: config_2.default.LIB_NAME, $lib_version: config_2.default.LIB_VERSION, $snapshot_host: snapshotHostname_1 }, (_this._unstringifiableEventsDropped > 0
                        ? { $sdk_debug_replay_unstringifiable_events_dropped: _this._unstringifiableEventsDropped }
                        : {})));
                }
                catch (e) {
    ...
    Object.defineProperty(LazyLoadedSessionRecording.prototype, "sdkDebugProperties", {
        get: function () {
            ...
            return _a = {
                    ...
                    $sdk_debug_replay_observer_init_failures: (_r = (_q = getRRWeb()) === null || _q === void 0 ? void 0 : _q.getObserverInitFailures) === null || _r === void 0 ? void 0 : _r.call(_q)
                },
