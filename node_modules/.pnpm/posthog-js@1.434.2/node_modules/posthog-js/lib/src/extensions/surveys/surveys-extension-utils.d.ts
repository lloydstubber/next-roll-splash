...
import { Survey, SurveyAppearance, SurveyPosition, SurveyQuestion, SurveyType, SurveyWidgetType } from '../../posthog-surveys-types';
...
export declare const clearAllInMemoryInProgressSurveyState: () => void;
