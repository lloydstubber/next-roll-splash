...
var request_dispatch_1 = require("./request-dispatch");
...
var PostHog = /** @class */ (function () {
    ...
    PostHog.prototype._init = function (token, config, name) {
        ...
        this._requestQueue = new request_queue_1.RequestQueue(function (req, transportOverride) { return _this._send_retriable_request(req, transportOverride); }, this.config.request_queue_config);
    ...
    PostHog.prototype._send_request = function (options) {
        (0, request_dispatch_1.sendRequest)(this, options);
    };
    PostHog.prototype._send_retriable_request = function (options, transportOverride) {
        if (this._retryQueue) {
            this._retryQueue.retriableRequest(options, transportOverride);
        }
        else {
            this._send_request(transportOverride ? __assign(__assign({}, options), { transport: transportOverride }) : options);
        }
    };
    /**
    ...
    Object.defineProperty(PostHog.prototype, "_facebookClickIdChannel", {
        ...
        get: function () {
            var _this = this;
            return {
                property: constants_1.FACEBOOK_CLICK_ID,
                persistenceKey: constants_1.PERSISTENCE_FACEBOOK_CLICK_ID,
                cookieName: '_fbc',
                pattern: FBC_PATTERN,
                register: function (value, delivered) {
                    var _a;
                    var _b;
                    return (_b = _this.persistence) === null || _b === void 0 ? void 0 : _b.register((_a = {}, _a[constants_1.PERSISTENCE_FACEBOOK_CLICK_ID] = { value: value, delivered: delivered }, _a));
                },
                unregister: function () { var _a; return (_a = _this.persistence) === null || _a === void 0 ? void 0 : _a.unregister(constants_1.PERSISTENCE_FACEBOOK_CLICK_ID); },
            };
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(PostHog.prototype, "_facebookBrowserIdChannel", {
        get: function () {
            var _this = this;
            return {
                property: constants_1.FACEBOOK_BROWSER_ID,
                persistenceKey: constants_1.PERSISTENCE_FACEBOOK_BROWSER_ID,
                cookieName: '_fbp',
                pattern: FBP_PATTERN,
                register: function (value, delivered) {
                    var _a;
                    var _b;
                    return (_b = _this.persistence) === null || _b === void 0 ? void 0 : _b.register((_a = {}, _a[constants_1.PERSISTENCE_FACEBOOK_BROWSER_ID] = { value: value, delivered: delivered }, _a));
                },
                unregister: function () { var _a; return (_a = _this.persistence) === null || _a === void 0 ? void 0 : _a.unregister(constants_1.PERSISTENCE_FACEBOOK_BROWSER_ID); },
            };
        },
        enumerable: false,
        configurable: true
    });
    PostHog.prototype._getPersistedMetaIdentifier = function (channel) {
        var _a;
        var stored = (_a = this.persistence) === null || _a === void 0 ? void 0 : _a.get_property(channel.persistenceKey);
        if ((0, core_1.isString)(stored) && channel.pattern.test(stored)) {
            return { value: stored, delivered: false };
        }
        if ((0, core_1.isObject)(stored) && (0, core_1.isString)(stored.value) && channel.pattern.test(stored.value)) {
    ...
    PostHog.prototype._storeMetaIdentifier = function (channel, value, stored) {
        if (value === (stored === null || stored === void 0 ? void 0 : stored.value)) {
            return { value: value, pending: !stored.delivered };
        }
        channel.register(value, false);
        return { value: value, pending: true };
    };
    // Read under the switches of the URL click ID: save_campaign_params off or cookieless mode skips the read.
    PostHog.prototype._readMetaCookie = function (channel) {
        if (!this.config.save_campaign_params || this._inCookielessMode()) {
            return undefined;
        }
        var value = (0, cookie_utils_1.getCookieValue)(channel.cookieName);
        return (0, core_1.isString)(value) && channel.pattern.test(value) ? value : undefined;
    };
    PostHog.prototype._updateFacebookClickId = function (fbclid, providedFbc, hasProvidedFbc, unsetFbc) {
        if (!this.persistence) {
            return undefined;
        }
        var channel = this._facebookClickIdChannel;
        this.persistence.refreshKey(channel.persistenceKey);
        var stored = this._getPersistedMetaIdentifier(channel);
        ...
        var urlClick = (0, core_1.isString)(fbclid) && FBCLID_PATTERN.test(fbclid) ? fbclid : undefined;
        var cookieFbc = this._readMetaCookie(channel);
        if (cookieFbc && fbcCookieWins(cookieFbc, urlClick, stored)) {
            return this._storeMetaIdentifier(channel, cookieFbc, stored);
        }
        if (urlClick) {
            if ((stored === null || stored === void 0 ? void 0 : stored.value.split('.')[3]) === urlClick) {
                return { value: stored.value, pending: !stored.delivered };
            }
            return this._storeMetaIdentifier(channel, "fb.1.".concat(Date.now(), ".").concat(urlClick), stored);
        }
    ...
    PostHog.prototype._updateFacebookBrowserId = function (providedFbp, hasProvidedFbp, unsetFbp) {
        if (!this.persistence) {
            return undefined;
        }
        var channel = this._facebookBrowserIdChannel;
        this.persistence.refreshKey(channel.persistenceKey);
        var stored = this._getPersistedMetaIdentifier(channel);
        ...
        if (hasProvidedFbp) {
            if (!(0, core_1.isString)(providedFbp) || !FBP_PATTERN.test(providedFbp)) {
                channel.unregister();
                return undefined;
            }
            return this._storeMetaIdentifier(channel, providedFbp, stored);
        }
        var cookieFbp = this._readMetaCookie(channel);
        if (cookieFbp) {
            return this._storeMetaIdentifier(channel, cookieFbp, stored);
        }
        return stored ? { value: stored.value, pending: !stored.delivered } : undefined;
    };
    PostHog.prototype._markMetaIdentifierDelivered = function (channel, value) {
        if (!this.persistence) {
            return;
        }
        this.persistence.refreshKey(channel.persistenceKey);
    ...
    PostHog.prototype.capture = function (event_name, properties, options) {
        ...
        var callerValueFor = function (property) {
            var _a;
            var hasOptionValue = !!(options === null || options === void 0 ? void 0 : options.$set) && property in options.$set;
            var hasPropertyValue = !!propertySet && property in propertySet;
            return {
                hasProvided: hasOptionValue || hasPropertyValue,
                provided: hasOptionValue ? (_a = options === null || options === void 0 ? void 0 : options.$set) === null || _a === void 0 ? void 0 : _a[property] : propertySet === null || propertySet === void 0 ? void 0 : propertySet[property],
                unset: propertyUnset.indexOf(property) !== -1 || optionUnset.indexOf(property) !== -1,
            };
        };
        var fbcCallerValue = callerValueFor(constants_1.FACEBOOK_CLICK_ID);
        var fbpCallerValue = callerValueFor(constants_1.FACEBOOK_BROWSER_ID);
        var metaIdentifiers = [
            {
                channel: this._facebookClickIdChannel,
                hasProvided: fbcCallerValue.hasProvided,
                update: this._updateFacebookClickId(campaignParams === null || campaignParams === void 0 ? void 0 : campaignParams.fbclid, fbcCallerValue.provided, fbcCallerValue.hasProvided, fbcCallerValue.unset),
            },
            {
                channel: this._facebookBrowserIdChannel,
                hasProvided: fbpCallerValue.hasProvided,
                update: this._updateFacebookBrowserId(fbpCallerValue.provided, fbpCallerValue.hasProvided, fbpCallerValue.unset),
            },
        ];
        try {
            for (var metaIdentifiers_1 = __values(metaIdentifiers), metaIdentifiers_1_1 = metaIdentifiers_1.next(); !metaIdentifiers_1_1.done; metaIdentifiers_1_1 = metaIdentifiers_1.next()) {
                var _j = metaIdentifiers_1_1.value, channel = _j.channel, hasProvided = _j.hasProvided, update = _j.update;
                if (update &&
                    ...
                    data.$set = __assign((_b = {}, _b[channel.property] = update.value, _b), data.$set);
                }
            }
        }
            ...
            try {
                if (metaIdentifiers_1_1 && !metaIdentifiers_1_1.done && (_a = metaIdentifiers_1.return)) _a.call(metaIdentifiers_1);
            }
        ...
        if (event_name === posthog_surveys_types_1.SurveyEventName.DISMISSED || event_name === posthog_surveys_types_1.SurveyEventName.SENT) {
            ...
            data.$set = __assign(__assign({}, data.$set), (_c = {}, _c[(0, survey_utils_1.getSurveyInteractionProperty)({ id: surveyId, current_iteration: surveyIteration }, event_name === posthog_surveys_types_1.SurveyEventName.SENT ? 'responded' : 'dismissed')] = true, _c));
        }
        else if (event_name === posthog_surveys_types_1.SurveyEventName.SHOWN) {
            data.$set = __assign(__assign({}, data.$set), (_d = {}, _d[posthog_surveys_types_1.SurveyEventProperties.SURVEY_LAST_SEEN_DATE] = new Date().toISOString(), _d));
        }
        if (event_name === posthog_product_tours_types_1.ProductTourEventName.SHOWN) {
            ...
            if (tourType) {
                data.$set = __assign(__assign({}, data.$set), (_e = {}, _e["".concat(posthog_product_tours_types_1.ProductTourEventProperties.TOUR_LAST_SEEN_DATE, "/").concat(tourType)] = new Date().toISOString(), _e));
            }
        }
        ...
        var metaIdentifiersToConfirm = metaIdentifiers.filter(function (_a) {
            var _b, _c, _d;
            var channel = _a.channel, update = _a.update;
            var finalValue = (_c = (_b = data.$set) === null || _b === void 0 ? void 0 : _b[channel.property]) !== null && _c !== void 0 ? _c : ((0, core_1.isObject)((_d = data.properties) === null || _d === void 0 ? void 0 : _d.$set) ? data.properties.$set[channel.property] : undefined);
            return (update === null || update === void 0 ? void 0 : update.pending) && finalValue === update.value;
        });
        this._internalEventEmitter.emit('eventCaptured', data);
        var url = (_f = options === null || options === void 0 ? void 0 : options._url) !== null && _f !== void 0 ? _f : this.requestRouter.endpointFor('api', this.analyticsDefaultEndpoint);
        var isSessionRecording = (options === null || options === void 0 ? void 0 : options._batchKey) === 'recordings' || /\/s\/(?:\?|$)/.test(url);
        var requestOptions = __assign(__assign(__assign({ method: 'POST', url: url, data: data, compression: 'best-available', preferSyncCompression: options === null || options === void 0 ? void 0 : options.send_instantly, timestampMode: isSessionRecording ? 'body' : 'capture-body', batchKey: options === null || options === void 0 ? void 0 : options._batchKey }, (isSessionRecording && ((_g = data.properties) === null || _g === void 0 ? void 0 : _g.$session_id)
            ? {
                batchGroup: data.properties.$session_id +
                    (data.properties.$window_id ? "-".concat(data.properties.$window_id) : ''),
            }
            : {})), ((options === null || options === void 0 ? void 0 : options.transport) ? { transport: options.transport } : {})), (metaIdentifiersToConfirm.length
            ? {
                ...
                callback: function (response) {
                    ...
                    if (response.statusCode >= 200 && response.statusCode < 300) {
                        try {
                            for (var metaIdentifiersToConfirm_1 = __values(metaIdentifiersToConfirm), metaIdentifiersToConfirm_1_1 = metaIdentifiersToConfirm_1.next(); !metaIdentifiersToConfirm_1_1.done; metaIdentifiersToConfirm_1_1 = metaIdentifiersToConfirm_1.next()) {
                                var _b = metaIdentifiersToConfirm_1_1.value, channel = _b.channel, update = _b.update;
                                _this._markMetaIdentifierDelivered(channel, update.value);
                            }
                        }
                        catch (e_3_1) { e_3 = { error: e_3_1 }; }
                        finally {
                            try {
                                if (metaIdentifiersToConfirm_1_1 && !metaIdentifiersToConfirm_1_1.done && (_a = metaIdentifiersToConfirm_1.return)) _a.call(metaIdentifiersToConfirm_1);
                            }
        ...
        if (this.config.request_batching &&
            ...
            if (!requestOptions.transport &&
                ...
                (0, core_1.isEmptyObject)((_h = this.config.request_headers) !== null && _h !== void 0 ? _h : {}) &&
    ...
    PostHog.prototype.identify = function (new_distinct_id, userPropertiesToSet, userPropertiesToSetOnce) {
        ...
        try {
            ...
            if (identityDidChange && isKnownAnonymous) {
                ...
                if (this.capture(constants_1.EVENT_IDENTIFY, identifyProperties, {
    ...
    PostHog.prototype.shutdown = function (_shutdownTimeoutMs) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_k) {
                ...
                void ((_c = this.metrics) === null || _c === void 0 ? void 0 : _c.flush('sendBeacon'));
                (_d = this.metrics) === null || _d === void 0 ? void 0 : _d.dispose();
                (_e = this._requestQueue) === null || _e === void 0 ? void 0 : _e.unload();
                (_f = this._retryQueue) === null || _f === void 0 ? void 0 : _f.unload();
                try {
                    (_g = this.featureFlags) === null || _g === void 0 ? void 0 : _g.destroy();
                }
                catch (error) {
                    logger_1.logger.error('Error while destroying feature flags', error);
                }
                (_h = this.persistence) === null || _h === void 0 ? void 0 : _h.destroy();
                (_j = this.sessionPersistence) === null || _j === void 0 ? void 0 : _j.destroy();
                return [2 /*return*/];
            });
        });
    };
    ...
    PostHog.prototype.set_config = function (config) {
        ...
        if ((0, core_1.isObject)(config)) {
            ...
            (_f = this.metrics) === null || _f === void 0 ? void 0 : _f.onConfigChange();
            (_g = this.sessionRecording) === null || _g === void 0 ? void 0 : _g.startIfEnabledOrStop();
            (_h = this.tracingHeaders) === null || _h === void 0 ? void 0 : _h.startIfEnabledOrStop();
            (_j = this.autocapture) === null || _j === void 0 ? void 0 : _j.startIfEnabled();
            (_k = this.heatmaps) === null || _k === void 0 ? void 0 : _k.startIfEnabled();
            if ('capture_pageview' in config || 'disable_capture_url_hashes' in config) {
                (_l = this.historyAutocapture) === null || _l === void 0 ? void 0 : _l.startIfEnabledOrStop();
            }
            (_m = this.exceptionObserver) === null || _m === void 0 ? void 0 : _m.startIfEnabledOrStop();
            (_o = this.deadClicksAutocapture) === null || _o === void 0 ? void 0 : _o.startIfEnabledOrStop();
            (_p = this.surveys) === null || _p === void 0 ? void 0 : _p.loadIfEnabled();
            this._sync_opt_out_with_persistence();
            (_q = this.externalIntegrations) === null || _q === void 0 ? void 0 : _q.startIfEnabledOrStop();
...
var add_dom_loaded_handler = function () {
    ...
    function dom_loaded_handler() {
        ...
        (0, request_dispatch_1.enableRequestSending)();
