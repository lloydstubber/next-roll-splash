...
var RetryQueue = /** @class */ (function () {
    ...
    RetryQueue.prototype.retriableRequest = function (_a, transportOverride) {
        var _this = this;
        ...
        (0, request_dispatch_1.sendRequest)(this._instance, transportOverride ? __assign(__assign({}, options), { transport: transportOverride }) : options, function (response, retryAfterMs) {
            var _a;
            if (response.statusCode !== 200 && (response.statusCode < 400 || response.statusCode >= 500)) {
                ...
                if ((retriesPerformedSoFar !== null && retriesPerformedSoFar !== void 0 ? retriesPerformedSoFar : 0) < maxRetries) {
                    _this._enqueue(__assign({ retriesPerformedSoFar: retriesPerformedSoFar }, options), retryAfterMs);
                    return;
                }
    ...
    RetryQueue.prototype._enqueue = function (requestOptions, retryAfterMs) {
        ...
        var msToNextRetry = Math.max(pickNextRetryDelay(retriesPerformedSoFar), retryAfterMs !== null && retryAfterMs !== void 0 ? retryAfterMs : 0);
