...
export type { MetricAttributeValue, MetricAttributes, MetricType, CaptureMetricOptions, MetricSample, BeforeSendMetricFn, OtlpMetricsPayload, MetricsConfig, BrowserMetricsConfig, NetworkMetricsConfig, NetworkMetricsRequest, NetworkMetricsResponse, } from '@posthog/types';
